...
## Current state (2026-07-02) — **user-creatable, testable TASKS** ("jobs, done right"): Phases 1–3 DONE + VERIFIED (backend + Tasks-page UI); awaiting review
