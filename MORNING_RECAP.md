...
## Current state (2026-07-02, EVENING) — **Connect model → engine switches + simplify the model/tune surface**: Phases 0–3 SHIPPED + PUSHED + VERIFIED; Phase 4 (docs) in flight
...
> **Phase 4 — docs + verify (this pass).** Plan persisted to `just-llm-runner/docs/plans/2026-07-02-model-switch-connect.md` (+ LIVE STATUS); the historical `2026-06-27-switch-and-preset-architecture.md` bannered with the 2026-07-02 evolution; this recap entry; full-suite re-verify.
