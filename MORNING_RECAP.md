...
## Current state (2026-07-02, LATER PM) — **Portable data root + "Install engine" split from "download model" + spawn diagnostics**: Phases 1–2 SHIPPED + PUSHED; Phase 3 (UI) BUILT + VERIFIED, commit pending (rules-checker re-pass in flight)
