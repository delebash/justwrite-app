...
**PHASE 1 PROGRESS — P1a–1e DONE + SHIPPED; P1f NEXT.** Committed + pushed on the branch: **runner `26f1ce7`** (P1a–1c) → **`9909d52`** (the P1d strict-diff, doc-only) → **`855abfd`** (P1d/P1e, rules-checker PASS). P1a–1c (all in `just-llm-runner/llm_runner/runner/process.py`) were runtime-INERT until 1d wired them:
