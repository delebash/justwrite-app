...
- **[Import and export](import-and-export.md)** — pull in a `.docx`, `.epub`, or `.odt` and turn it into chapters.

If you want to plan first:

- **[Story bible](story-bible.md)** — Characters, Locations, Objects, Groups, Relations.
- **[Plot and time](plot-and-time.md)** — Narrative strands, the Plot Board, Timelines, and Events.
