...
writeFileSync(`${health.dataDir}/logs/justwrite.log.${SEED_DAY}`, [
  "2026-07-02 10:00:00,000 [INFO] seed: info line one",
  "2026-07-02 10:00:01,000 [INFO] seed: info line two",
  "2026-07-02 10:00:02,000 [ERROR] seed: boom happened",
...
try {
  ...
  await page.getByRole("option", { name: new RegExp(SEED_DAY) }).click();
  await sleep(700);
