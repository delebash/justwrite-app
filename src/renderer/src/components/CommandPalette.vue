...
const NAV_ITEMS = [
  ...
  { id: "nav:studio",   label: "Studio",               sublabel: "Audiobook pipeline",  icon: "Headphones", to: "/studio" },
...
const ACTION_ITEMS = computed(() => {
  const list = [
    ...
    { id: "act:newCharacter", label: "New character",  sublabel: "Action",       icon: "Plus",
      run: () => { const id = project.addCharacter(); router.push(`/characters/${id}`); } },
    { id: "act:newLocation", label: "New location",    sublabel: "Action",       icon: "Plus",
      run: () => { const id = project.addLocation(); router.push(`/locations/${id}`); } },
    { id: "act:newObject", label: "New object",        sublabel: "Action",       icon: "Plus",
      run: () => { const id = project.addObject(); router.push(`/objects/${id}`); } },
    { id: "act:newNote", label: "New note",            sublabel: "Action",       icon: "Plus",
      run: () => { const id = project.addNote(); router.push(`/notes/${id}`); } },
    { id: "act:newStrand", label: "New strand",        sublabel: "Action",       icon: "Plus",
      run: () => { const id = project.addStrand(); router.push(`/strands/${id}`); } },
